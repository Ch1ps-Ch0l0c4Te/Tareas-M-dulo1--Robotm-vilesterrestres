...
puntos = [1,2; 3,7; 6,0; -4,5; -6,0; -1,0; -7,-7; -2,-4; -0.5,-0.5; 1,-3; 3,-5; 8,0; 0,-3; 0,9; 0,-1; -5,-10; 7,-7; 3,-1; -10,-10; 10,9];
pt = 17; %este se cambia del 1 al 20 dependiendo del punto que quiere verse
hxd=puntos(pt,1);
hyd=puntos(pt,2);
...
for k=1:N 
    ...
    kv = 1.5; %valor para hacer pruebas
    K=[kv 0;...
       0 kv];
    %d)Ley de Control
    qpRef= pinv(J)*K*he;
...
axis([-11 11 -11 11 0 1]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
